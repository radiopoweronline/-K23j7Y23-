...
function openModal(title, description, imageSrc = null) {
    ...
    if (imageSrc) {
        // Mostrar imagen con botón "Cerrar" sobre la imagen
        modalContent.innerHTML = `
            <div class="text-center relative">
                ...
                <button onclick="closeModal()" class="absolute bottom-0 left-1/2 transform -translate-x-1/2 -translate-y-2 bg-pink-500 hover:bg-pink-600 px-6 py-2 rounded-full transition-all">
                    Cerrar
                </button>
            </div>
        `;
